...
import 'EditproDoctor.dart';
import 'LoginDoctor.dart';



class AccountPageDoctor extends StatelessWidget {
  final LocalStorage _localStorage = LocalStorage(const FlutterSecureStorage());
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => EditProfileDoctor(localStorage: _localStorage)),
                    );
                  },
                  style: ButtonStyle(
