      ...
      child: Obx(() {
        return ListView.builder(
          ...
          itemBuilder: (_, index) {
            ...
            } else if (task.repeat == "Monthly".tr &&
    ...
    Get.bottomSheet(
      Container(
        ...
        child: Column(children: [
          ...
          const Spacer(),
          _bottomSheetButton(
            label: "Update Task".tr,
            color:const Color(0x8A919191),
            onTap: () {
              Get.back();
